...
<div id="block_myaccount_infos" class="links wrapper">
  ...
  <div class="title clearfix hidden-md-up" data-target="#footer_account_list" data-toggle="collapse">
    <span class="h3">{l s='My account' d='Shop.Theme.CustomerAccount'}</span>
  ...
  <ul class="account-list collapse" id="footer_account_list">
        <li>
            <a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='my account' d='Shop.Theme.CustomerAccount'}"> {l s='My account' d='Shop.Theme.CustomerAccount'}</a>
        </li>
