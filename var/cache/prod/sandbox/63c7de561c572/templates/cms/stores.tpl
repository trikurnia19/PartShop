        ...
        <div class="store-item-container clearfix">
          ...
          <div class="col-md-5 col-sm-7 col-xs-12 store-description">
            ...
            {if $store.note || $store.phone || $store.fax || $store.email}
              <a data-toggle="collapse" href="#about-{$store.id|escape:'html':'UTF-8'}" aria-expanded="false" aria-controls="about-{$store.id|escape:'html':'UTF-8'}"><strong>{l s='About and Contact' d='Shop.Theme'}</strong><i class="material-icons">&#xE409;</i></a>
            {/if}
          </div>
