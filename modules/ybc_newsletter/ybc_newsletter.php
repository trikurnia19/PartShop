    ...
    public function __construct()
	{
        ...
        $this->configs = array(
            ...
            'YBC_NEWSLETTER_POPUP_TITLE' => array(
                'label' => $this->l('Title'),
                'type' => 'text',
                'default' => $this->templates['ynpt6']['YBC_NEWSLETTER_POPUP_TITLE'],
                'lang' => true,
            ), 
            'YBC_NEWSLETTER_POPUP_SUBTITLE' => array(
                'label' => $this->l('SubTitle'),
                'type' => 'text',
                'default' => $this->templates['ynpt6']['YBC_NEWSLETTER_POPUP_SUBTITLE'],
                'lang' => true,
            ),
            'YBC_NEWSLETTER_POPUP_CONTENT' => array(
                'label' => $this->l('Popup content'),
                'type' => 'textarea',
                'default' => $this->templates['ynpt6']['YBC_NEWSLETTER_POPUP_CONTENT'],               
                'lang' => true,
                'autoload_rte' => true,                
            ),
